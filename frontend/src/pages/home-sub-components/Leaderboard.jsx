...
const Leaderboard = () => {
  ...
  return (
   ...
   <section className="my-8 lg:px-5">
        ...
        <tbody className="text-gray-700">
          {
            ...
            Array.isArray(leaderboard) && leaderboard.slice(0,10).map((element,index)=>{
              return (
                 <tr key={element._id}
    ...
    <Link to={"/leaderboard"} className="border-2 border-stone-200 font-bold text-xl w-full py-2 flex justify-center rounded-md
    hover:border-stone-500 transition-all  duration-300">Go to Leaderboard</Link>
   </section>
   </>
  );
}
