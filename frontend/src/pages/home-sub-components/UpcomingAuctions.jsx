      ...
      <div className="flex flex-wrap gap-6">
        ...
        {auctionsStartingToday.slice(0, 6).map((element) => (
          <Link
            ...
            key={element._id}
            className="w-full flex flex-col gap-4 bg-white p-2 rounded-md 2xl:gap-2 hover:shadow-md transition-all duration-300 lg:flex-1 2xl:basis-64 2xl:flex-grow"
          >
