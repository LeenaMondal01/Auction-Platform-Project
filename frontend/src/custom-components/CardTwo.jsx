    ...
    <>
      <div className="basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80">
        <img
          src={imgSrc}
          alt={title}
          className="w-full aspect-[3/3] m-auto md:p-12"
        />
        <div className="px-2 pt-4 pb-2">
          ...
          <div className='flex flex-col gap-2 mt-4'>
            ...
            <button
              className="bg-red-400 text-center text-white text-x1 px-4 py-2 rounded-md
            ...
            <button
              ...
              className="bg-sky-400 text-center text-white text-x1 px-4 py-2 rounded-md transition-all duration-300 hover:bg-sky-700"
            >
              Republish Auction
            </button>
          </div>
