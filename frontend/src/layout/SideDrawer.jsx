  ...
  return (
    <>
      <div
        ...
        className="fixed right-5 top-5 bg-[#D6482B] text-white text-3xl p-2 rounded-md hover:bg-primaryHover lg:hidden"
      >
        <GiHamburgerMenu />
      </div>

      <div
        className={`w-full sm:w-[300px] bg-[#F6F4F0] h-full fixed top-0 ${show ? "left-0" : "left-[-100%]"}
